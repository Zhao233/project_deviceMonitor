...
//            Page<DeviceInfo_all> page = deviceInfoDao.getAll_latest(pageable);
//
//            for( DeviceInfo_all deviceInfo_all : page.getContent() ){
//                try {
//                    /**
//                     * 将展示给客户的deviceInfo更换为服务器内的数据
//                     * */
//                    deviceInfo_all = deviceInfoSearchService.replaceDeviceInfoFromRemoteServer(deviceInfo_all);
//
//                    deviceInfo_all.setUpdateTime(DateTimeUtil.getCSTTimeFromUTC(deviceInfo_all.getUpdateTime()));
//
